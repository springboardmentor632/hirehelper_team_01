...
const Login = () => {
    ...
    return (
        // Full viewport container with the light green background (bg-highlight)
        <div className="min-h-screen flex items-center justify-center bg-bg-highlight p-4 font-sans">
            ...
            <div className="flex max-w-5xl w-full">
                ...
                <div className="hidden lg:flex flex-col flex-1 justify-center pr-10">
                    ...
                    {/* Logo Display */}
                    <div className="w-48 h-48 bg-bg-highlight flex items-center justify-center mb-4 rounded-full">
                        <img src={logo} alt="HireHelper Logo" className="w-full h-full bg-bg-highlight object-contain p-4" />
                    </div>
                ...
                <div className="flex flex-col flex-1 max-w-md lg:max-w-none w-full items-center">
                    ...
                    {/* Right Panel: Login Form Card (bg-app and card shadow) */}
                    <div className="bg-bg-app p-8 md:p-10 rounded-lg border-[2px] border-action-accept shadow-card flex flex-col items-center w-full max-w-md">
                        ...
                        <form className="w-full max-w-sm" onSubmit={handleLogin}>
                            ...
                            <button
                                type="button"
                                className="w-full max-w-[280px] py-4 bg-action-accept text-action-decline font-bold text-base rounded-md transition hover:bg-opacity-80 mx-auto block"
                            >
